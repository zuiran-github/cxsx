            ...
            <el-row>
              <el-col :span="10" :offset="1">
                <el-form-item label="出发地" prop="departure">
                  <el-select v-model="ruleForm.departure" filterable placeholder="请选择出发地">
                    <el-option
              ...
              <el-col :span="10" :offset="1">
                <el-form-item label="目的地" prop="destination">
                  <el-select v-model="ruleForm.destination" filterable placeholder="请选择目的地">
                    <el-option
                      v-for="item in options"
                      :key="item"
                      :label="item"
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      if(this.ruleForm.departure==undefined||this.ruleForm.departure==""){
        alert("请选择出发地！");
      }else{
        if(this.ruleForm.destination==undefined||this.ruleForm.destination==""){
          alert("请选择目的地！");
        }else{
          if(this.ruleForm.date1==undefined||this.ruleForm.date1==""){
            alert("请选择日期！")
          }
          else{
