...
class DazhongSpider:
    ...
    def getRHtml(self, url):
        try:
            ...
            header = {}
            header['User-Agent'] = mfu.UserAgent().random()#'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36'
