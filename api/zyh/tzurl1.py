...
tzurl = getTZURL('BJS','SHA','上海虹桥机场','北京大兴国际机场','2021-06-25','MF')
tzurl1 = getTZURL('BJS','SHA','上海虹桥机场','北京大兴国际机场','2021-06-25','HO')
tzurl2 = getTZURL('BJS','SHA','上海虹桥机场','北京大兴国际机场','2021-06-25','KN')
print(tzurl)
print(tzurl1)
print(tzurl2)
